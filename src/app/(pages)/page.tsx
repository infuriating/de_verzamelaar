...
export default function Home() {
  return (
    <div className="text-center h-minusheader flex gap-8 justify-center items-center flex-col md:grid md:grid-cols-2">
      <div>
        ...
        <Link href={"/products"}>
          <Button className="mt-4 rounded-[.25rem] font-semibold">
            View Products
          </Button>
        </Link>
      </div>
